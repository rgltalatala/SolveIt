...
import { cornerSlotSolved, mustPreserveCornerIds, type CornerSlotId } from './cornerSlotModel'
...
export function preservesLessonStateAfterDemo(
  ...
  return mustPreserve.every((id) => cornerPreservedAtLessonHold(after, id, holdIndex))
}
...
export function isVerifiedCornerSlotDemo(
  ...
  return (
    ...
    mustPreserve.every((id) => cornerPreservedAtLessonHold(after, id, holdIndex))
  )
}
