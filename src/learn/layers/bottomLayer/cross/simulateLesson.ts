...
import type { SimulateWhiteCrossLessonResult, WhiteCrossLessonStep } from './types'
...
export function simulateWhiteCrossLessonOnStorageCube(
  ...
  const result = simulateLessonOnStorageCube<WhiteCrossLessonStep>(storageCube, maxLessonSteps, {
