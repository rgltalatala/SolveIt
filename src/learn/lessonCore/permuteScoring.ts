...
export function pickBestPermuteInTier<TId, TStep extends { demoMoves?: Move[] }>(args: {
  studentState: CubeState
  ...
  const score = (candidate: PermuteCandidate<TId, TStep>): [number, number, number, number] => {
