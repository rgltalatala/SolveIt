...
export function LearningSplitLayout({
  ...
  return (
    ...
    >
      <div className="flex h-[min(38dvh,280px)] shrink-0 flex-col min-h-[200px] lg:h-full lg:min-h-0 lg:shrink">
...
export const LEARNING_CUBE_FRAME_CLASS =
  'h-full min-h-[200px] w-full overflow-hidden rounded-xl border border-slate-700 bg-slate-950';
