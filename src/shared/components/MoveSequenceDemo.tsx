...
import { cubeStateToCubeJsString } from '@/domains/cube/cubeStateToFacelets';
import {
  getDemoStepChipLabel,
  type DemoStep,
  type Instruction,
} from '@/domains/lesson-engine/studentHold/index';
import { MOVE_ANIMATION_MS, MOVE_ANIMATION_PAUSE_MS } from '@/domains/cube/3d/moveAnimation';
...
import { getMoveSequenceSummary } from '@/features/lesson/utils/getMoveSequenceSummary';
import { demoMoveChipClassName } from '@/features/lesson/utils/demoMoveChipClassName';
import { LessonInstructionDemo } from '@/features/lesson/components/LessonInstructionDemo';
