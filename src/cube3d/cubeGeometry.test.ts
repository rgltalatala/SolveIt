...
import { applyMove, createSolvedCubeState, FACE_COLOR_CONVENTION } from '../cube/cubeState'
import type { Color, CubeState, Face, FaceState, Move } from '../cube/cubeState'
import { FACELET_ORDER, cubeStateToCubeJsString } from '../cube/cubeStateToFacelets'
...
describe('cubeJsStickerSlots / faceStickerIndex', () => {
  it('matches cubeStateToCubeJsString for every sticker after legal scrambles', () => {
    const moves: Move[] = ['R', "U'", 'F2', 'D', 'L2', 'B', "D'", 'R2', 'x', "y'", 'z2', 'F', 'R', 'U']
