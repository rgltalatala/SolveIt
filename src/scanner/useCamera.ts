...
const CAMERA_ERROR_MAP: Record<string, string> = {
  ...
  NotReadableError: 'Camera is unavailable because it is being used by another app.',
  OverconstrainedError: 'The selected camera constraints are not supported on this device.',
}
