import type { Color, Face, Move } from '@/domains/cube/cubeState';
import {
  formatColorLabel,
...
import {
  ...
  rotationY2,
  rotationYPrime,
} from '@/content/beginner/studentHold';
import { facePosition } from '@/content/notation/notation';
import type { DemoStep } from '@/domains/lesson-engine/studentHold/expandDemoSteps';
import { FACE_MAP, getFaceFromMove, getModifierFromMove } from '@/domains/lesson-engine/studentHold/translateMove';
import type { StudentHold, YRotationStep } from '@/domains/lesson-engine/studentHold/types';
