...
import { whiteCornersSteps } from '@/content/beginner/whiteCorners';
import { whiteCornerIdentity } from '@/content/beginner/pieceIdentity';
...
import { verifiedFrdDemoAtHold, studentHoldView } from '@/domains/lesson-engine/layers/bottomLayer/corners/frdViewDemoBuild';
import { expectedCornerColors } from '@/domains/lesson-engine/layers/bottomLayer/corners/cornerSlotModel';
import type { CornerSlotId, WhiteCornersLessonStep } from '@/domains/lesson-engine/layers/bottomLayer/corners/types';
import { buildFrdULayerDemo, uLayerInsertStepBody } from '@/domains/lesson-engine/layers/bottomLayer/corners/uLayerSteps';
import { buildFrdWrongDLayerDemo, wrongDSlotStepBody } from '@/domains/lesson-engine/layers/bottomLayer/corners/wrongDLayerSteps';
