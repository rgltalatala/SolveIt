...
import { normalizeHoldToBlue, type CornerHoldIndex } from '@/domains/lesson-engine/layers/bottomLayer/corners/cornerHold';
import { CORNER_ORDER, type CornerSlotId } from '@/domains/lesson-engine/layers/bottomLayer/corners/types';
