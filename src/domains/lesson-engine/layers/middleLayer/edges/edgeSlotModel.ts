...
import { holdFacingOpposite } from '@/domains/lesson-engine/layers/middleLayer/edges/edgeHold';
import {
  alignMovesToPartnerCenter,
  isPartnerAlignedToCenter,
} from '@/domains/lesson-engine/layers/middleLayer/edges/uLayerAlign';
import { findEdgeWithColors } from '@/domains/lesson-engine/layers/bottomLayer/shared/pieceQueries';
import { formatColor } from '@/domains/lesson-engine/layers/bottomLayer/shared/index';
import { MIDDLE_EDGE_SLOTS, type MiddleEdgeSlotId } from '@/domains/lesson-engine/layers/middleLayer/edges/types';
