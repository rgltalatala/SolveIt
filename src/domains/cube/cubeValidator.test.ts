...
import type { Color, CubeState, Face, FaceState, Move } from '@/domains/cube/cubeState';
import { FACELET_ORDER } from '@/domains/cube/cubeStateToFacelets';
import { validation as validationCopy } from '@/content/onboarding/ui';
