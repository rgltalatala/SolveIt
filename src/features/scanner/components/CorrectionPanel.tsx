...
import { FACE_COLOR_CONVENTION, lockFaceCenter } from '@/domains/cube/cubeState';
import type { Face, FaceState } from '@/domains/cube/cubeState';
import { correction as correctionCopy, ui } from '@/content/onboarding/ui';
import { ColorPicker } from '@/features/scanner/components/ColorPicker';
import { FaceGrid } from '@/features/scanner/components/FaceGrid';
