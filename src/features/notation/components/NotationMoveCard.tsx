...
import type { NotationMoveKind } from '@/features/notation/hooks/useNotationCube';
import { notationCardId } from '@/features/notation/utils/notationMoves';
...
export function NotationMoveCard({
  ...
  return (
    <button
      type="button"
      className={`flex min-w-0 w-full flex-col items-start gap-1 rounded-lg border bg-slate-950/40 px-3 py-2 text-left transition-colors hover:border-slate-500 ${borderClass} ${ringClass}`}
