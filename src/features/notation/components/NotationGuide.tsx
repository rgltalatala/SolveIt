...
import type { CubiePieceType, CubeAnatomyHighlight } from '@/domains/cube/3d/cubeAnatomy';
...
import { NotationMoveCard } from '@/features/notation/components/NotationMoveCard';
import { PieceTypeCard } from '@/features/notation/components/PieceTypeCard';
import { PositionLabelCard } from '@/features/notation/components/PositionLabelCard';
import {
  CUBE_ROTATION_MOVES,
  FACE_NAME_LABELS,
  FACE_TURN_MOVES,
  faceTurnDescription,
  rotationDescription,
} from '@/features/notation/utils/notationMoves';
import { useNotationCube } from '@/features/notation/hooks/useNotationCube';
import { usePrefersHover } from '@/shared/hooks/usePrefersHover';
import {
  LearningSplitLayout,
