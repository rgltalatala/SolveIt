...
import { setNotationIntroCompleted } from '@/domains/notation/notationPreferences';
import { notationIntro } from '@/content/onboarding/onboarding';
import { useCubeStore } from '@/app/store/cubeStore';

/** Welcome copy and scan handoff shown on the Learn tab during first-time notation intro. */
