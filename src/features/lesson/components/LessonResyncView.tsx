...
import { lessonLabels, resyncCopy, ui } from '@/content/onboarding/ui';
import { clearAllLessonDemoCaches } from '@/domains/lesson-engine/lessonCore/index';
import { saveLessonSession } from '@/features/lesson/store/lessonSessionPersistence';
import {
  isLessonAheadOf,
  resyncLessonFromScan,
  type LessonResyncResult,
} from '@/domains/lesson-engine/lessonResync';
