...
import { resolveLessonStorageDemo } from '@/domains/lesson-engine/layers/bottomLayer/corners/index';
import {
  getRotationText,
  type DemoStep,
  type Instruction,
...
import { cornersLessonProgress } from '@/features/lesson/utils/lessonProgressBuilders';
