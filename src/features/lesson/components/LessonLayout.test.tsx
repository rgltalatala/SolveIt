...
import { colorHexMap } from '@/domains/cube/cubeColors';
...
describe('LessonProgress', () => {
  ...
  it('hides per-slot labels in compact mode', () => {
    render(
      <LessonProgress
        compact
        progress={{
          ...
          slots: [
            ...
            { key: 'DR', label: 'White–Red', solved: false, isCurrent: true },
    ...
    expect(screen.getByText('1 / 4')).toBeInTheDocument();
    expect(screen.queryByText('White–Blue')).not.toBeInTheDocument();
  });
