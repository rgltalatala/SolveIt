...
import { createSolvedCubeState, applyMoves } from '@/domains/cube/cubeState';
...
vi.mock('@/features/lesson/components/LessonViewShell', () => ({
  LessonViewShell: ({
    header,
    step,
    cube,
...
vi.mock('@/features/lesson/hooks/bottomLayer/useWhiteCornerLessonStep', () => ({
