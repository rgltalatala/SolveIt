import {
  ...
  lastLayerLesson,
} from '@/content/beginner/lastLayer';
import type { LastLayerIntroId } from '@/domains/lesson-engine/layers/lastLayer/types';
import type { LastLayerProgressPhase } from '@/features/lesson/utils/lessonProgressBuilders';
