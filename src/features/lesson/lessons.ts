...
import { LAST_LAYER_LESSON_ID, LAST_LAYER_SUB_LESSONS } from '@/domains/lesson-engine/layers/lastLayer/index';
...
import { lastLayerLesson, LAST_LAYER_SUB_LESSON_LABELS } from '@/content/beginner/lastLayer';
